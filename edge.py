...
class TestLogInPage:
    ...
    def setup_method(self):
        ...
        edge_driver_binary = r"./drivers/msedgedriver.exe"
    ...
    def test_end_to_end_buy_product(self):
        ...
        time.sleep(4)
        button = self.driver.find_element(By.XPATH, "/html/body/div[6]/div[3]/div/div[2]/div/div/form/div[2]/div[1]/div[2]/div[9]/div/button")
        button.click()
        time.sleep(2)
